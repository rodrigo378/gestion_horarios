    ...
    this.cursoService
      ...
      .subscribe({
        next: (res: any) => {
          ...
          this.mostrarModalCrear = false;
          this.alertService.success('Éxito', 'Se creó el grupo correctamente');
        },
        ...
        `;
                    ...
                    <div style="padding:8px 10px; border-bottom:1px solid #e5e7eb;">
                      ...
                      <div style="margin-top:4px; color:#374151;">
                        <a href="/coa/asignar/${c.turno_id}" target="_blank" style="color:#2563eb; text-decoration:none; font-weight:500;">
                          🔗 Ver turno ${c.turno_id} (Darle click para abrir calendario)
                        </a>
                      </div>
          ...
          this.alertService.error(mensajeHTML, '⛔ Conflicto detectado');
        },
      });
  }
