...
export class VerTurnosComponent implements OnInit {
  ...
  docentes: docenten[] = [
    { id: 1, categoria: 'Director/Decano/VRA', c_nomdoc: 'Juan Pérez', h_min: 8, h_max: 16, tipo: 1, h_total: 0 },
    { id: 2, categoria: 'Director/Decano/VRA', c_nomdoc: 'Ana Gómez', h_min: 9, h_max: 17, tipo: 1, h_total: 0 },
    { id: 3, categoria: 'Jefe/Coordinador', c_nomdoc: 'Carlos Ramírez', h_min: 7, h_max: 15, tipo: 2, h_total: 0 },
    { id: 4, categoria: 'Jefe/Coordinador', c_nomdoc: 'María López', h_min: 10, h_max: 18, tipo: 2, h_total: 0 },
    { id: 5, categoria: 'TC', c_nomdoc: 'Pedro Sánchez', h_min: 6, h_max: 14, tipo: 3, h_total: 0 },
    { id: 6, categoria: 'TC', c_nomdoc: 'Elena Rojas', h_min: 11, h_max: 19, tipo: 3, h_total: 0 }
  ];
